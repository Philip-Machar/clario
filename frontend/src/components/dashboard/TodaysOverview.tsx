...
const TodaysOverview: FC<TodaysOverviewProps> = ({ tasks, isLoading = false }) => {
  ...
  return (
    <section className="px-10 pb-2">
      <div className="rounded-2xl border border-slate-800/80 bg-gradient-to-br from-slate-950/80 via-slate-950/40 to-slate-950/10 px-6 py-3 shadow-[0_18px_60px_rgba(0,0,0,0.65)] backdrop-blur-xl flex items-center justify-between">
